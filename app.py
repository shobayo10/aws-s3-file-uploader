...
bucketName = 'my-unique-bucket-name-1860'

s3 = boto3.client('s3', region_name=regionName)
s3r = boto3.resource('s3',region_name=regionName)

# 
# Create a new bucket
#
print(">> Creating bucket named: " + bucketName + "\n")
cbResponse = s3.create_bucket(Bucket=bucketName, CreateBucketConfiguration={ 'LocationConstraint': 'us-west-2' })
